...
#define RT0 			10000.0		// Reference resistor
#define Beta 			3430.0			// Beta
#define R0 				10000			// Resistor on voltage divider
#define R10k 10000.0
//#define B 3570
...
//	Temperature_C = temp_C;
  ...
  Temperature_C = 1 / ((1/T0) + (1/Beta) * log( (R0/RT0) * (( 4096.0 / adc_value_ELN_TEMP ) - 1) )) - 273.15;
